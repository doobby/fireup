...
- 联合开发
  ...
  在我的职业生涯中曾经当过几年联合开发者。这里提供了大多数软件开发工作，相比于获取更多经验而言你将获得更高的报酬⭕️。 

- 嵌入式软件

  嵌入式软件是将代码烧入一个定制芯片，这类软件运行在你的汽车、电梯控制器和手持GPS设备中。

  这个领域我不太熟悉，除了知道这类工作更类似于构建硬件而不是软件，自从你获得一次成功（一旦产品推出就不需要重新发布）⭕️。这种工作发布和测试周期很长，因为不需要二次开发。我不时地寻找嵌入式软件开发工作职位，在我的经验（十分有限）看来，是一个不错的工作选择。

  编写嵌入式软件会很有挑战性，同时你也可以获得很多薪资，但是与联合开发相比它的工作可选性很有限。薪资回报同样趋向于比联合开发低些，

- 游戏开发

  如果你喜爱游戏⭕️，构建它会很爽⭕️。它同样有巨大的工作量。我从游戏开发者获取的第一手描述都表明他们热爱这份工作，但是讨厌一周长时间加班（60-80小时）。相比联合开发，薪酬回报同样趋向较低，这说的通吗？如果你在构建一个收费应用比如光环3你会接受工资削减吗？⭕️
